...
class CommentHandler(webapp2.RequestHandler):
    def post(self):
        ...
        if event.user != "Anonymous" and event.user != email:
            mail.send_mail(sender="socialeventcalendar@socialeventcalendar.appspotmail.com", to=event.user,
                           subject="Someone commented on your post!",
                           body="Someone commented on your post! Click here to see it: socialeventcalendar.appspot.com/event?id=" + id)
...
class ProcessForm(webapp2.RequestHandler):
    def post(self):
        ...
        event_number = models.create_event(title, summary, information, start_date, end_date, start_time, end_time,
                                           attendance, location, email)
...
class EditHandler(webapp2.RequestHandler):
    ...
    def post(self):
        ...
        event_number = models.edit_event(title, summary, information, start_date, end_date, start_time, end_time,
